...
module.exports = __webpack_require__.p + "./img/90e98538b55175c04053.png";
...
;// CONCATENATED MODULE: ./src/ts/tilt.ts

window.addEventListener("load", function () {
    vanilla_tilt_default().init(Array.prototype.slice.call(document.querySelectorAll(".link")), {
        max: 15,
        reverse: true,
        scale: 1.1,
        speed: 500,
...
function add_attribute(name, value, boolean) {
    if (value == null || (boolean && !value))
        return '';
    return ` ${name}${value === true && boolean_attributes.has(name) ? '' : `=${typeof value === 'string' ? JSON.stringify(internal_escape(value)) : `"${value}"`}`}`;
}
...
// EXTERNAL MODULE: ./src/img/profile.png
var profile = __webpack_require__(413);
;// CONCATENATED MODULE: ./src/svelte/index.svelte
/* src/svelte/index.svelte generated by Svelte v3.46.4 */
...
function create_each_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*links*/ 2 && t0_value !== (t0_value = /*link*/ ctx[2].name + "")) set_data(t0, t0_value);

			if (dirty & /*links*/ 2 && a_href_value !== (a_href_value = /*link*/ ctx[2].url)) {
...
function create_fragment(ctx) {
	...
	let t2;
	let t3;
	let t4_value = /*info*/ ctx[0].con + "";
	let t4;
	let t5;
	document.title = title_value = /*info*/ ctx[0].name;
	...
	return {
		c() {
			...
			attr(link, "href", profile);
			attr(link, "type", "image/x-icon");
			attr(div0, "id", "profile");
			attr(span, "id", "con");
		...
		p(ctx, [dirty]) {
			if (dirty & /*info*/ 1 && title_value !== (title_value = /*info*/ ctx[0].name)) {
				document.title = title_value;
			}

			if (dirty & /*info*/ 1 && t2_value !== (t2_value = /*info*/ ctx[0].name + "")) set_data(t2, t2_value);
			if (dirty & /*info*/ 1 && t4_value !== (t4_value = /*info*/ ctx[0].con + "")) set_data(t4, t4_value);
...
class Svelte extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { info: 0, links: 1 });
	}
}

/* harmony default export */ const index_svelte = (Svelte);
...
/* harmony default export */ const ts = ((/* unused pure expression or super */ null && (index)));
